        ...
        a(
          a(
            a(
              {
                ...
                shows: function () {
                  ...
                  var a = this;
                  wx.request({
                    url: t.globalData.api + "wx_fkmydj.ashx",
                    data: {
                      vipcode: wx.getStorageSync("vipcode"),
                      wxuserid: wx.getStorageSync("wxuserid"),
                    ...
                    success: function (t) {
                      if ((console.log(t.data), t.data.length > 0)) {
                        a.setData({
                          ...
                          sumprice: t.data[0].SUMPRICE,
                          sumsqprice: t.data[0].SUMSQPRICE,
                          xf_amtsold: t.data[0].XF_AMTSOLD,
            ...
            function () {
              var a = this;
              wx.request({
                url: t.globalData.api + "wx_upaddr.ashx",
                data: { xf_docno: a.data.xf_docno, shid: a.data.shid },
          ...
          "payment",
          function () {
            if (0 == this.data.sumyfprice) return this.upaddr(), !1;
            var a = this;
            wx.login({
              success: function (e) {
                var s = e.code;
