...
Page({
  ...
  onLoad: function (a) {
    ...
    wx.getSystemInfo({
      success: function (a) {
        t.setData({
            videohight: parseInt(0.75 * a.windowWidth)
          }),
      ...
      wx.request({
        ...
        success: function (a) {
          ...
          t.setData({
            ...
            a.data[0].TBIMAGES1 &&
            (t.setData({
                "swiperlist[0]": t.data.pict + a.data[0].XF_PLU + "//" + a.data[0].TBIMAGES1,
              }),
              console.log(t.data.swiperlist[0])),
            a.data[0].TBIMAGES2 &&
            t.setData({
              "swiperlist[1]": t.data.pict + a.data[0].XF_PLU + "//" + a.data[0].TBIMAGES2,
            }),
            a.data[0].TBIMAGES3 &&
            t.setData({
              "swiperlist[2]": t.data.pict + a.data[0].XF_PLU + "//" + a.data[0].TBIMAGES3,
            }),
