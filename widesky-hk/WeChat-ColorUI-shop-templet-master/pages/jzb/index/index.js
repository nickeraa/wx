...
Page({
  ...
  onLoad: function (e) {},
  szqg: function () {
    wx.navigateTo({ url: "/pages/szqg/index/index" });
  },
  ddqh: function () {
    wx.navigateTo({ url: "/pages/scqhdeposit/index/index" });
  },
  sqtk: function () {
    wx.navigateTo({ url: "/pages/sqtkdeposit/index/index" });
  },
  checknumber: function () {
    wx.navigateTo({ url: "/pages/checknumber/index/index" });
  },
  xgdj: function () {
    wx.navigateTo({ url: "/pages/xgdj/index/index" });
  },
  qd: function () {
    var e = this;
...
qhlist()
{
  ...
  selectmaps: function (o) {
    ...
    var a = this;
    e.reverseGeocoder({
      location: { latitude: Number(t[0]), longitude: Number(t[1]) },
      success: function (o) {
        ...
        for (var s = [], c = 0; c < a.data.addr.length; ++c)
          (s = a.data.addr[c].LOCATION),
            ...
            e.calculateDistance({
              mode: "straight",
              from: { latitude: Number(t[0]), longitude: Number(t[1]) },
              to: [
                {
              ...
              success: function (e) {
                ...
                console.log("计算距离为:", o + "米"),
                  ...
                  o < 100 &&
                    (a.setData({ name: a.data.addr[c].ADDRES, address: "" }),
  ...
  upstate: function (e, n, t) {
    ...
    wx.request({
      ...
      data: { tag: e, userid: n, sctime: t },
      header: { "content-type": "application/x-www-form-urlencoded" },
      dataType: "json",
      success: function (e) {
        console.log(e), a.setData({ tags: "3", tag: "3" });
      },
    });
  },
  stopstart: function () {
          ...
          "ok" == e.data
            ? (wx.removeStorageSync("qd"),
              wx.showModal({
                ...
                success: function (e) {
                  e.confirm &&
                    wx.navigateTo({ url: "/pages/qgqt/index/index" });
                },
              }))
            : wx.showModal({
                title: "提示",
  ...
  cxqg: function () {
    wx.navigateTo({ url: "/pages/shstate/index/index" });
  },
  postsc: function () {
    wx.navigateTo({ url: "/pages/postsc/index/index" });
  },
  sclist: function () {
    wx.navigateTo({ url: "/pages/screport/index/index" });
  },
  vip: function () {
    wx.navigateTo({ url: "/pages/vipsku/index/index" });
  },
  gz: function () {
        ...
        return (
          ...
          !e.data[0].GOPENID && e.data[0].OPENID
            ? (wx.showModal({
                ...
                success: function (e) {
                  e.confirm &&
                    wx.navigateTo({ url: "/pages/wxgz/index/index" });
                },
              }),
              !1)
            : e.data[0].GOPENID || e.data[0].OPENID
  ...
  tp: function (e) {
    wx.getStorageSync("job")
      ...
      : wx.navigateTo({ url: "/pages/tplogin/index" });
  },
  djsq: function (e) {
    wx.getStorageSync("job")
      ? wx.showModal({
      ...
      : wx.navigateTo({ url: "/pages/dqnumber/index/index" });
  },
  cxsq: function (e) {
    wx.getStorageSync("job")
      ? wx.showModal({
      ...
      : wx.navigateTo({ url: "/pages/cxqstock/index/index" });
  },
  gzmessage: function () {
    wx.getStorageSync("job")
      ? wx.showModal({
      ...
      : wx.showModal({
          ...
          showCancel: !1,
          success: function (e) {
            e.confirm && wx.navigateTo({ url: "/pages/wxgz/index/index" });
          },
        });
  },
  khdj: function () {
...
console.log(wx.getStorageSync("userid"))
    ...
    wx.getStorageSync("job")
      ...
      : ((o.globalData.tt = ""),
        wx.navigateToMiniProgram({
          ...
          extraData: { yguserid: wx.getStorageSync("userid") },
          envVersion: "release",
          success: function (e) {
            console.info(e);
          },
  ...
  ch: function () {
    wx.navigateTo({ url: "/pages/acxpech/index/index" });
  },
  newvip: function () {
    wx.navigateToMiniProgram({
      appId: "wx187fe5b10e271c63",
  ...
  oldvip: function () {
    wx.navigateTo({ url: "/pages/acxpexls/index/index" });
  },
  history: function () {
    wx.navigateTo({ url: "/pages/ahistory/index/index" });
  },
  qg: function () {
    wx.getStorageSync("job")
      ? wx.showModal({
  ...
  lphz: function () {
    wx.getStorageSync("job")
      ...
      : wx.navigateTo({ url: "/pages/viplp/index/index" });
  },
  ...
  qdhz: function () {
    wx.getStorageSync("job")
      ...
      : wx.navigateTo({ url: "/pages/viphz/index/index" });
  },
  ...
  bdqw: function () {
    wx.getStorageSync("job")
      ...
      : wx.navigateTo({ url: "/pages/seprice/index/index" });
  },
  fstate: function () {
    wx.getStorageSync("job")
      ? wx.showModal({
            ...
            e.data.length > 0
              ? (n.setData({
                ...
                wx.request({
                  ...
                  dataType: "json",
                  success: function (e) {
                    console.log(e), n.setData({ addr: e.data });
                  },
                }))
              : wx.showModal({
                  title: "提示",
