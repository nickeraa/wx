...
Page({
  ...
  goback: function () {
    wx.redirectTo({ url: "/pages/scar/index/index" });
  },
      ...
      success: function (o) {
        console.log(o),
          ...
          "0" != e.data.tag && "9" != e.data.tag
            ...
            : wx.request({
                url: t.globalData.api + "wx_checknumber.ashx",
                data: {
                ...
                success: function (t) {
                  console.log(t),
                    ...
                    "订单号验证成功，配额成功！" == e.data.warning
                      ? (e.setData({ show: "true" }),
                        wx.showModal({
                          title: "提示",
                          content: "订单号验证成功，配额成功！",
                          showCancel: !1,
                          success: function (t) {
                            t.confirm && e.tzbody();
                          },
