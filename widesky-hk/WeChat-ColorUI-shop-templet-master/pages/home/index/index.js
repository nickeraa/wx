...
Page({
  ...
  scxs: function () {
    wx.getStorageSync("job")
      ...
      : wx.navigateTo({ url: "/pages/scarxs/index/index" });
  },
  gz: function () {
  ...
  khdj: function () {
    wx.getStorageSync("job")
      ...
      : wx.navigateTo({ url: "/pages/hkhome/index/index" });
  },
  tp: function () {
    wx.getStorageSync("job")
      ? wx.showModal({
      ...
      : wx.navigateTo({ url: "/pages/tpsq/index/index" });
  },
  zc: function () {
    wx.getStorageSync("job")
      ? wx.showModal({
      ...
      : ((e.globalData.tt = ""),
        wx.navigateTo({ url: "/pages/acxpe/index/index" }));
  },
  center: function () {
    wx.getStorageSync("job")
      ? wx.showModal({
      ...
      : wx.navigateTo({ url: "/pages/scar/index/index" });
  },
  cxpe: function () {
    wx.getStorageSync("job")
      ? wx.showModal({
      ...
      : wx.navigateTo({ url: "/pages/cxpe/index/index" });
  },
  qxtp: function () {
    wx.getStorageSync("job")
      ? wx.showModal({
      ...
      : wx.navigateTo({ url: "/pages/qxtp/index/index" });
  },
  td: function () {
    wx.getStorageSync("job")
      ? wx.showModal({
