  ...
  function n(t, r) {
    return void 0 === r
      ? t >= 32
        ? t - 32
        : t + 64
      : parseInt(String.fromCharCode(t) + String.fromCharCode(r));
  }
  function c(t, h) {
    var n = u(t);
  ...
  exports.code128 = function (r, o, l, d) {
    ...
    for (
      var p = (function (r) {
        ...
        g = new a(r, l, d),
        v = g.area.width / (11 * (p.length - 3) + 35),
        w = g.area.left,
        _ = g.area.top,
        b = 0;
      b < p.length;
