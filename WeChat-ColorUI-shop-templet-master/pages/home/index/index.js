...
Page({
  ...
  onShow: function () {
    console.log(e.globalData.m),
      ...
      "4" == wx.getStorageSync("p") &&
        wx.setTabBarBadge({ index: 2, text: wx.getStorageSync("n") }),
  ...
  onIndex: function () {
    ...
    wx.request({
      ...
      data: { vipcode: wx.getStorageSync("vipcode"), i: "" },
      header: { "content-type": "application/x-www-form-urlencoded" },
      dataType: "json",
      success: function (e) {
        if ((console.log(e.data), 0 == e.data.length))
          a.setData({ flag: !1, replu: null, flagss: !0 });
        else {
  ...
  search: function (a) {
    if ("" == this.data.skuname)
      return (
        wx.showToast({ title: "请输入关键词", icon: "error", duration: 1e3 }),
        !1
      );
    var t = this;
    wx.request({
      url: e.globalData.api + "wx_cgname.ashx",
      data: { name: t.data.skuname },
      header: { "content-type": "application/x-www-form-urlencoded" },
      dataType: "json",
      success: function (e) {
        console.log(e.data),
          e.data.length > 0
            ? t.setData({ replus: e.data })
            : (t.setData({ replus: null }),
              wx.showToast({
                title: "没有记录哦",
                icon: "error",
                duration: 2e3,
      ...
      success: function (e) {
        console.log(e.data),
          0 == e.data.length
            ...
            : a.setData({ replus: e.data, flags: !1 });
      },
    });
  },
  shuaxin: function () {
    ...
    wx.request({
      url: e.globalData.api + "wx_fxpage.ashx",
      data: { vipcode: wx.getStorageSync("vipcode"), i: a.data.i },
      header: { "content-type": "application/x-www-form-urlencoded" },
      dataType: "json",
      success: function (e) {
        console.log(e.data),
  ...
  inuser: function () {
    ...
    wx.request({
      ...
      success: function (e) {
        console.log(e),
          "error" == e.data &&
            wx.showToast({ title: "数据错误", icon: "none", duration: 2e3 });
      },
    });
  },
  ...
  ykdata: function () {
    ...
    wx.request({
      ...
      success: function (e) {
        console.log(e.data),
          a.setData({ replu: e.data, flag: !0, flags: !0, flagss: !0 });
      },
    });
  },
});
