var e, a = require("../../../@babel/runtime/helpers/defineProperty"), t = getApp(), s = require("../../../utils/util.js");
...
Page({
    ...
    a(a(a(a(e, "picker3", []), "index3", null), "xf_staffcode", ""), "i", "")),
    ...
    vip_sort: function() {
        ...
        wx.showLoading({
            ...
            url: t.globalData.api + "wx_vipyd.ashx",
            data: {
