        ...
        wx.request({
            ...
            success: function(a) {
                ...
                t.data.picker2.push({
                    XF_CODE: "999",
                    XF_DESCI: "全部类别"
                }), console.log(t.data.picker2), t.setData({
                    picker2: t.data.picker2
                });
            }
        });
    },
        ...
        wx.request({
            ...
            success: function(a) {
                console.log(a), a.data.length > 0 ? (t.setData({
                    ...
                    rv: "",
                    amtsold: parseFloat(t.data.oldamtsold.toFixed(2)) + parseFloat(a.data[0].AMTSOLD.toFixed(2))
                }), console.log(t.data.newamtsold), console.log(t.data.oldamtsold), console.log(t.data.amtsold)) : (t.setData({
                    rejob: null
                }), t.data.replu || (t.setData({
                    rv: !0
                }), wx.showModal({
                    title: "提示",
                    content: "没有记录！",
    ...
    selectvip: function() {
        ...
        wx.showLoading({
            ...
            success: function(a) {
                ...
                }), console.log(t.data.oldamtsold), console.log(t.data.amtsold)) : t.setData({
                    replu: null
