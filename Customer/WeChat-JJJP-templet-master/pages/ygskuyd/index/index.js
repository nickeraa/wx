...
Page({
    ...
    newsaleslist: function(a) {
        wx.navigateTo({
            url: "/pages/ygskusyd/index/index?xf_staffcode=" + a.currentTarget.dataset.xf_salesman + "&xf_storecode=" + this.data.store + "&begindate=" + this.data.date + "&enddate=" + this.data.date2 + "&qtysold=" + a.currentTarget.dataset.qtysold + "&xf_name=" + a.currentTarget.dataset.xf_name + "&xf_plu=" + this.data.xf_plu
        });
    },
    checkinput: function() {
    ...
    vip_newvip: function() {
        ...
        wx.showLoading({
            ...
            url: a.globalData.api + "wx_hzygvipyd.ashx",
            data: {
